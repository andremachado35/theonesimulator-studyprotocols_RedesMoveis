...
public class MessageEventGenerator implements EventQueue {
	...
	/*Joao Pereira  adição ao event generator o id_event*/
	...
	public MessageEventGenerator(Settings s){
		...
		/*Joao Pereira read the group of destiny of the message*/
	...
	public ExternalEvent nextEvent() {
		...
		* ADD TO getToGROUP VARIABLE */
		MessageCreateEvent mce = new MessageCreateEvent(from, to, this.getID(), 
				msgSize, responseSize, this.nextEventsTime, toGroup);

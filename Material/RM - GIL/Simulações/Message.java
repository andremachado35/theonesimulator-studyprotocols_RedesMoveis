...
public class Message implements Comparable<Message> {
	...
	private int initTtl;
	private String payload; //VAMOS VER SE ISTO É ASSIm
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		this.payload = from.getLocation().toString(); //ACHO que esta linha vai buscar as coordenadas, em string, do host que gera a mensagem

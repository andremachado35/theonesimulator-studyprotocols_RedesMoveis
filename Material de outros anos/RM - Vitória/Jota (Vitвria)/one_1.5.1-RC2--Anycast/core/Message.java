...
public class Message implements Comparable<Message> {
	...
	/*name of the group of destination JOÃO PEREIRA*/
	 ...
	 */
	public Message(DTNHost from, DTNHost to, String id, int size, String toGroup) {
		this.from = from;
		this.to = to;
		this.id = id;
		this.size = size;
	...
	public Message replicate() {
		Message m = new Message(from, to, id, size, toGroup);
		m.copyFrom(this);
		return m;
	}
	...
	/** @return the group from the message*/
